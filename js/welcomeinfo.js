...
$.ajax({
    ...
    data: {
        key: 'PMWBZ-YFCHL-YQKP4-MOFS3-YCTB3-Y4FPD',
        output: 'jsonp',
    },
    dataType: 'jsonp',
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(118.2654, 24.3955, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
            ...
            document.getElementsByClassName("announcement_content")[0].innerHTML =
                `欢迎来自<span>${pos}</span>的朋友，${timeChange}<br>
        你距离綺晴约有<span>${dist}</span>公里，${posdesc}
        <br>
        <br>
        歡迎來到綺晴的混亂空間
        `;
